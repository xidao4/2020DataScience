...
fileName_record="d_record_dict.json"
fileName_pro="d_pro_dict.json"
outPath="d_pro_detail_dict.json"
...
f=open(fileName_record,encoding="utf8")
res=f.read()
record_dict=json.loads(res)

f=open(fileName_pro,encoding="utf8")
res=f.read()
...
with open(outPath,mode='w',encoding="utf8") as f:
    f.write(json_pro)
with open('../RDI/'+'d_difficulty_dict.json',mode='w',encoding="utf8") as f:
    f.write(json_pro)
with open('../PDI/'+outPath,mode='w',encoding="utf8") as f:
    f.write(json_pro)